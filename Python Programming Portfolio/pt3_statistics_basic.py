...
while True: # Starts all the code in a loop
    try: # Tries the code indented
        for i in range(0, 5): # Has 5 numbers then proceeds to cycle i through each number in the list
        ...
        for i in sorted(numbers_list, reverse=True): # Cycles i through the sorted number_list, reverses the list to sort from highest to lowest
